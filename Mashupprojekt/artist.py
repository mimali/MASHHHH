...
def get_artist(artistId,req):
    """
    Hämtar den valda artistens top 10 låtar från spotify med hjälp av
...
def find_video(Tracklist, req, Urllist):
    """
    Funktionen använder låttitlarna för att söka efter låtnamnens Youtube ID tillsammans
    med artistnamnt efter deras YoutubeID. IDt används sedan för att göra en URL
